...
class NeuralNetwork(object):
    def __init__(self, input_nodes, hidden_nodes, output_nodes, learning_rate):
        ...
        # as shown below.
        self.activation_function = lambda a : 1/(1 + np.exp(-a))  # Replace 0 with your sigmoid calculation.
    ...
    def forward_pass_train(self, A):
        ...
        hidden_inputs = np.matmul(A[None, :], self.weights_input_to_hidden) # signals into hidden layer
        hidden_outputs = self.activation_function(hidden_inputs) # signals from hidden layer

        # TODO: Output layer - Replace these values with your calculations.
        final_outputs = np.matmul(hidden_outputs, self.weights_hidden_to_output) # signals into final output layer
    ...
    def backpropagation(self, final_outputs, hidden_outputs, X, y, delta_weights_i_h, delta_weights_h_o):
        ...
        error_1 = y - final_outputs # Output layer error is the difference between desired target and actual output.
        
        # TODO: Calculate the hidden layer's contribution to the error
        hidden_error = error_1 * self.weights_hidden_to_output
        
        # TODO: Backpropagated error terms - Replace these values with your calculations.
        output_error_term = error_1 * 1
    ...
    def run(self, features):
        ...
        return np.matmul(hidden_outputs, self.weights_hidden_to_output) # signals into final output layer
